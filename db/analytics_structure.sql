...
--
-- Name: dcloud_analytics_development; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE dcloud_analytics_development WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';


\connect dcloud_analytics_development
