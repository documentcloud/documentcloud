...
namespace :import do
  ...
  task :accounts, [:slug, :csv] => :environment do |_t, args|
    Organization.transaction do
      begin
        ...
        CSV.foreach(args[:csv]) do |fname, lname, email, is_admin|
          ...
          role = is_admin ? Account::ADMINISTRATOR : Account::CONTRIBUTOR
          ...
          organization.add_member(account, role)
...
# generate a password with using commonly confused characters
