...
dc.ui.UploadDialog = dc.ui.Dialog.extend({
  ...
  _onStarted : function(e, queueId) {
    ...
    if (this.options.replacePagesStart) attrs.replace_pages_start = this.options.replace_pages_start;
    if (this.options.replacePagesEnd) attrs.replace_pages_end = this.options.replace_pages_end;
