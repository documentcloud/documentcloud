...
dc.ui.UploadDialog = dc.ui.Dialog.extend({
  ...
  _onStarted : function(e, queueId) {
    ...
    if (this.options.replacePagesStart) attrs.replace_pages_start = this.options.replacePagesStart;
    if (this.options.replacePagesEnd) attrs.replace_pages_end = this.options.replacePagesEnd;
