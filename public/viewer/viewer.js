...
DV.Schema.states = {
  ...
  ViewThumbnails: function() {
    ...
    this.thumbnails.renderThumbnails();
    return true;
  }
...
window.JST['pages'] = _.template('<div class="DV-set p<%= pageIndex %>" data-id="p<%= pageIndex %>" style="top:0;left:0px;height:893px;width:700px;">  <div class="DV-overlay"></div>  <div class="DV-pageNoteInsert" title="Click to Add a Page Note">    <div class="DV-annotationTab">      <div class="DV-annotationClose"></div>    </div>    <div class="DV-annotationDivider"></div>  </div>  <div class="DV-pageMeta"><span class="DV-pageNumber">p. <%= pageNumber %></span></div>  <div class="DV-annotations"></div>  <div class="DV-page" style="height:863px;width:700px;">    <span class="DV-loading-top">Loading</span>    <span class="DV-loading-bottom">Loading</span>    <div class="DV-cover"></div>    <img class="DV-pageImage" src="<%= pageImageSource %>" height="863" />  </div></div>');
window.JST['thumbnails'] = _.template('<% _.each(thumbnails, function(thumbnail, page) { %>  <div class="DV-thumbnail DV-zoom-<%= zoom %>" id="DV-thumbnail-<%= page %>">    <div class="DV-overlay <% if (removedPages[page]) { %>visible<% } %>"></div>    <div class="DV-thumbnail-page">      <div class="DV-thumbnail-image"><img src="<%= thumbnail %>" /></div>      <div class="DV-pageNumber DV-pageMeta">p. <%= page %></div>    </div>  </div><% }); %>');
